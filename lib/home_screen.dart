...
import 'package:ludoapp/ludo_provider.dart';
import 'package:ludoapp/widgets/board_widget.dart';
import 'package:ludoapp/widgets/dice_widget.dart';
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text("This game made with Flutter ❤️ by Prakash Shrestha", style: TextStyle(color: Colors.white, fontSize: 15), textAlign: TextAlign.center),
